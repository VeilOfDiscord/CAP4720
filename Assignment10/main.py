...
def render_scene():
    ...
    shaderProgram_scene["eye_pos"] = rotated_eye
    shaderProgram_scene["matColour"] = material_color_slider.get_color()

    shaderProgram_scene["lightProjectionMatrix"] = light_projection_mat
    shaderProgram_scene["lightViewMatrix"] = light_view_mat
    shaderProgram_scene["lightPosition"] = lightPos
...
# Write our shaders.
# Shader to generate the depth texture (shadow map) from light's point of view
...
material_color_slider = gui.add_color_picker(label_text="Material Color", initial_color=(1, 1, 1))
...
PCF_radio = gui.add_radio_buttons(label_text="PCF",options_dict={"On": 0,"Off": 1,})
